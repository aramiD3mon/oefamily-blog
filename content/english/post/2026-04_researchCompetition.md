+++
author = "JB Borge"
title = "Research on building a 10-resident assisted care home in Maricopa County"
date = "2026-04-26"
description = "Success depends on targeting an underserved niche (high-touch, RN-oversight small homes) rather than competing directly with large institutional facilities"
tags = [
    "questions",
    "compare",
    "facility",
...
series = ["Guide"]
aliases = ["guide"]
thumbnail = "images/ArizonaCave.jpg"
+++
...
| Factor | Details |
|-----|-----|
| Current Supply | Maricopa County has ~790,000 residents aged 65+ (16.9% of population) but most assisted living is in large facilities (avg. 37 beds). Small residential homes (≤10 residents) are fewer than 15 per many counties and often haven't changed hands in a decade |
| Competition Level | Moderate-to-high for large facilities, but low for premium small homes. A 2025 study found Maricopa's senior facilities are "underserved," with most being small-scale single-family operations and few high-quality options |
| New Supply | A 40-resident assisted living center is proposed in Maricopa city, confirming the gap. Phoenix metro has rapidly growing retiree population from in-state aging + West Coast relocations |
| Existing Businesses for Sale | 18 home health care businesses and 11 long-term care/assisted living facilities currently listed for sale in Maricopa County, indicating active market but also exit opportunities |

Key Insight: The market is not saturated with small, high-quality residential homes. Most competition comes from large, institutional facilities that lack personalization.
...
This trend matters because assisted care demand is driven less by short-term economic cycles and more by long-run demographic need. As people live longer with chronic conditions, mobility challenges, medication complexity, and cognitive decline, families increasingly look for settings that can provide supervision, personal care, and routine health monitoring without the feel of a nursing institution.
...
A practical way to think about the model is this: a home charging roughly $6,000 to $9,000 per resident per month could generate about $720,000 to $1,080,000 in annual gross revenue at full occupancy. Even if occupancy stabilizes below 100 percent, the model can still produce meaningful top-line revenue provided labor, mortgage or lease costs, licensing costs, food, insurance, and compliance expenses are controlled.
...
Areas worth emphasizing include:

- RN-led medication management and condition monitoring, which can reduce family anxiety and support safer care transitions.
- Strong caregiver-to-resident attention, especially if the home can genuinely deliver personalized routines rather than rigid institutional schedules.
- Meal planning that is customized for diabetes, heart health, swallowing needs, or cultural preferences rather than generic menu service.
- Direct family communication, including regular updates and transparent care plans, which many families value more than luxury amenities.
- A specialty focus such as memory support, fall-prevention programming, or high-touch transitional care after hospital discharge, provided licensing and training support that scope.
...
This matters strategically because the service promise must match licensure, staffing capability, training, and the physical layout of the house.If the business intends to serve residents with dementia-related needs or market memory support in a formal way, the current regulatory framework should be reviewed carefully, including more recent memory care-related requirements and subclass distinctions.
...
- Selecting a property in a senior-dense submarket with favorable access to hospitals, referral sources, and adult children who influence placement decisions.
- Building referral relationships with hospital discharge planners, geriatric care managers, home health agencies, hospice providers, and local physicians.
...
The concept is most compelling if it delivers three things consistently: excellent caregiving, credible clinical oversight, and a family experience that feels more personal and transparent than traditional assisted living.
